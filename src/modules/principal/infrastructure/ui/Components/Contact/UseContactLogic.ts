...
// Use cases
//
import {RegexUseCases} from "../../../../../shared/application/RegexUseCases.ts";
import {ContactUseCases} from "../../../../application/ContactUseCases.ts";
import {ToastUseCases} from "../../../../../shared/application/ToastUseCases.ts";
...
// Controllers
//
import {EmailRegex} from "../../../../../shared/infrastructure/utils/regex/EmailRegext.ts";
import {
    NotEmpty,
    OnlyNumberLettersSpaceAndMin3Lenght
} from "../../../../../shared/infrastructure/utils/regex/CustomRegex.ts";
import {ContactController} from "../../../controllers/ContactController.ts";
import {ToastController} from "../../../../../shared/infrastructure/controllers/ToastController.ts";
...
export const useContactLogic = () => {
    ...
    const onSubmit = async (event: React.FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        if (isSended) {
            ToastUseCases.ShowSuccess(toastController, 'Thanks for contacting me! I will respond as soon as possible.')
