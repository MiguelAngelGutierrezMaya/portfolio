...
export const useBackCarouselLogic = () => {
    ...
    const items: Item[] = [
        ...
        },
        {
            ...
            githubLink: '',
            image: `${PUBLIC_FIREBASE_URL}/backend.webp?alt=media&token=0a631641-627a-4b30-ab78-de4d93ba6324`,
            technologies: ['Node.js', 'AWS Lambda', 'AWS SQS', 'Redis', 'Nest.js', 'TypeScript', 'MongoDB', 'Docker']
        },
        {
            title: '4.0 Brands services',
            description: '4.0 Brands services is a mono-repository service that manage farmers, products, orders and inventory.',
            githubLink: '',
            image: `${PUBLIC_FIREBASE_URL}/backend.webp?alt=media&token=0a631641-627a-4b30-ab78-de4d93ba6324`,
        ...
        },
        {
            ...
            description: 'Colegium microservices is an architecture for the management of different services related to the educational context, digital signature service and information management.',
            githubLink: '',
            image: `${PUBLIC_FIREBASE_URL}/backend.webp?alt=media&token=0a631641-627a-4b30-ab78-de4d93ba6324`,
        ...
        },
        {
            ...
            description: 'Tip top english is a management service for meetings, materials, classes and English courses.',
        ...
        },
        {
            ...
            description: 'Siellano is a medical context management service related to appointments, patients, physicians and historical medical information.',
