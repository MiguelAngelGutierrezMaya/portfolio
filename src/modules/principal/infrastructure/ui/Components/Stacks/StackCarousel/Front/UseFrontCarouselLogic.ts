...
export const useFrontCarouselLogic = () => {
    ...
    const items: Item[] = [
        {
            title: 'Keybe v6',
            description: 'Keybe v6 is a multi-channel application for managing customer conversation, CRM, campaigns and funnel management using AI at the core.',
            githubLink: '',
        ...
        {
            title: 'Biky',
            description: 'Biky is a platform where customers can configure their AI assistant, manage its capabilities and customize its appearance.',
            githubLink: '',
        ...
        {
            title: 'Keybe Flows',
            description: 'Flows is a platform where customers can configure bot flows and manage integrations to store information with external third-party services.',
            githubLink: '',
        ...
        {
            title: 'Keybe Metrics',
            description: 'Metrics is a platform where customers can interactively review their sales information, lead information and team performance.',
            githubLink: '',
        ...
        },
        {
            ...
            description: '4.0 Cosechapp is a platform where farmers can manage their products, orders, and products inventory',
            githubLink: '',
        ...
        },
        {
            ...
            description: 'Syncrasy is a platform where customers can manage their information related with medical issues',
            githubLink: '',
        ...
        },
        {
            ...
            description: 'Tip top english is a platform to manage meetings, materials, classes and English courses',
        ...
        {
            title: 'Siellano',
            description: 'Siellano is a platform for managing medical contexts related to appointments, patients, physicians and historical medical information.',
