...
import {useArticleContentLogic} from "./UseArticleContentLogic.ts";
...
const ArticleContent: React.FC<ArticleContentProps> = ({title, timeline, description, datetime, companyImage, url}) => {
    //
    // React components
    //
        ...
        <article
            ...
            <div className="md:col-span-3 group relative flex flex-col items-start">
                <h2 className="text-base font-semibold tracking-tight text-zinc-100">
                    <div
                        className="absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl bg-zinc-800/50"></div>
                    {url && (
                ...
                <time
                    ...
                    <span
                        ...
                        aria-hidden="true">
                        <span
                            className="h-4 w-0.5 rounded-full bg-zinc-500"></span>
                    </span>
                    {timeline}
                </time>
