...
// Hooks
//
import {useSectionLinkWithPopoverLogic} from "./UseSectionLinkWithPopoverLogic.ts";
...
const SectionLinkWithPopover: React.FC<SectionLinkWithPopoverProps> = ({title, onClick, onClickWhasapp}) => {
    //
    // Hooks
    //
